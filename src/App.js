  ...
  return (
    <div className='header field'>
      ...
      <div className='colour-border'>
        ...
        <DisplayBlock customstyle="field" label="VAT to pay: " value={vatToPay.toFixed(2)} />
        <PriceEntryField customstyle="field" label="Price incl VAT: " priceChanged={handleGrossPriceChange.toFixed(2)} price={grossPrice === 0.0 ? "" : grossPrice} />
      </div>
    </div>
  );
}
